...
class CustomFields
{
    ...
    public function render_meta_boxes($post)
    {
        ...
        echo '<p><label for="abcbizrev_review_name">' . esc_html__('Name:', 'abcbiz-reviews') . '</label>';
        echo '<input type="text" id="abcbizrev_review_name" name="abcbizrev_review_name" value="' . esc_attr($name) . '" class="widefat" /></p>';

        echo '<p><label for="abcbizrev_review_email">' . esc_html__('Email:', 'abcbiz-reviews') . '</label>';
        ...
        echo '<p><label for="abcbizrev_review_rating">' . esc_html__('Rating:', 'abcbiz-reviews') . '</label>';
