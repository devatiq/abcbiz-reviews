...
class ABCBIZRevPostTypes {
    ...
    public function register_custom_post_type() {
        $labels = array(
            'name'                  => _x( 'ABCBizRev Reviews', 'abcbiz-reviews'),
            'singular_name'         => _x( 'ABCBizRev Review', 'abcbiz-reviews'),
            'menu_name'             => __( 'ABCBizRev Reviews', 'abcbiz-reviews'),
            ...
            'add_new'               => __( 'Add New', 'abcbiz-reviews'),
            ...
            'featured_image'        => __( 'Featured Image', 'abcbiz-reviews'),
            'set_featured_image'    => __( 'Set featured image', 'abcbiz-reviews'),
            'remove_featured_image' => __( 'Remove featured image', 'abcbiz-reviews'),
            'use_featured_image'    => __( 'Use as featured image', 'abcbiz-reviews'),
